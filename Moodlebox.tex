...
Grâce à la persévérance d'un membre de la communauté\footnote{Christian W, \url{https://moodle.org/user/view.php?id=1378197&course=20}, qu'il en soit ici remercié}, une première version de la méthode de construction d'une MoodleBox a été créée\footnote{\url{https://moodle.org/mod/forum/discuss.php?d=331170}}. Le présent document se fonde sur cette première version. Il décrit comment construire une MoodleBox à base d'une Raspberry Pi 3.
...
La mise à jour du microcode de Raspbian corrige un bogue\footnote{\url{https://www.raspberrypi.org/forums/viewtopic.php?f=28&t=44044&start=425}} qui gèle la Raspberry dès connexion à un point d'accès Wi-Fi.\footnote{Le bogue est présent dans l'image du 18 mars 2016. Il sera corrigé dans une prochaine image.}
...
\end{lstlisting}
La dernière commande ci-dessus détermine que la version installée par Git est la version 3.0.x stable actuelle.
...
\centering
\includegraphics[width=7.5cm]{cache-application.png}
\end{minipage}
\hspace{0.25cm} % To get a little bit of space between the figures
\begin{minipage}[b]{0.45\linewidth}
\centering
\includegraphics[width=7.5cm]{cache-sessions.png}
\end{minipage}
\end{figure}
...
Si tout s'est bien passé, la totalité ne doit pas dépasser la taille de 1.8~Go. L'image-disque, une fois tronquée, a une taille d'un peut plus de 2~Go. Compressée, elle tient dans un peu plus de 900~Mo. 
