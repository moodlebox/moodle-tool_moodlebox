...
Il s'agit d'éviter que la Raspberry récupère une adresse dynamique sur son interface Wi-Fi, risquant d'entrer en conflit avec son adresse fixe. On modifie le fichier \lstinline{/etc/network/interfaces}
\begin{lstlisting}[language=bash]
$ sudo nano /etc/network/interfaces
\end{lstlisting}

Sous la ligne \lstinline{iface wlan0 inet manual}, on supprime (ou met en commentaire) la ligne
\begin{lstlisting}[language=bash]
