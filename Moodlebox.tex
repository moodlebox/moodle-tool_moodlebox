...
Pour terminer, on quitte la session, et on se connecte à la MoodleBox avec le nouveau nom et le mot de passe \emph{Moodlebox4\$}, qui n'a pas été changé.
...
$ sudo chown -R pi:www-data files/
