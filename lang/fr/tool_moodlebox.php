...
$string['changesettings'] = 'Changer les réglages';
...
$string['currentwifichannel'] = 'Canal Wi-Fi actuel';
$string['currentwifipassword'] = 'Mot de passe Wi-Fi actuel';
$string['currentwifissid'] = 'Nom actuel du réseau Wi-Fi (SSID)';
...
$string['missingconfigurationerror'] = 'Cette section n\'est pas disponble, car l\'installation du plugin n\'est pas complète. Le réglage ne peut donc pas être traité par la MoodleBox. Veuillez consulter la <a href="https://github.com/martignoni/moodle-tool_moodlebox/blob/master/README.md" target="_blank">documentation d\'installation</a> afin de corriger cette erreur.';
$string['newwifichannel'] = 'Nouveau canal Wi-Fi';
$string['newwifipassword'] = 'Nouveau mot de passe Wi-Fi';
$string['newwifissid'] = 'Nouveau nom du réseau Wi-Fi (SSID)';
...
$string['wifichannelerror'] = 'Le canal Wi-Fi doit être un nombre entier entre 1 et 11.';
...
$string['wifisettingsmessage'] = 'Les réglages du réseau Wi-Fi ont été modifié. N\'oubliez pas de communiquer le nouveau nom du réseau (SSID) et le nouveau mot de passe à vos étudiants.';
