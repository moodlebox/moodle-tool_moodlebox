...
$string['projectinfo'] = '<p>The <a href="https://moodlebox.net/en/" title="MoodleBox website" target="_blank">MoodleBox project</a> is a volunteer, non-profit, spare time and open source project carried out by Nicolas Martignoni.</p><p>Support this project by <a href="https://moodlebox.net/en/donate/" title="Make a donation" target="_blank">making a donation</a>. Your donation will help fund the equipment needed to develop the MoodleBox and host its documentation.</p>';
...
$string['showbuttonsinfooter_desc'] = 'When enabled, the restart and shutdown buttons are displayed in the footer of all pages of the site, when logged in as an administrator.';
