...
$string['staticipaddress_help'] = 'This is the static IP address of the MoodleBox Wi-Fi access point. It also defines the DHCP range of IP addresses given to Wi-Fi clients. It must be a valid IP address.';
$string['staticipaddressinvalid'] = 'This IP address is invalid. It must be a valid IP address.';
