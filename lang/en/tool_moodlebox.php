...
$string['currentwifichannel'] = 'Current Wi-Fi channel';
$string['currentwifipassword'] = 'Current Wi-Fi password';
$string['currentwifissid'] = 'Current Wi-Fi network name (SSID)';
...
$string['newwifichannel'] = 'New Wi-Fi channel';
$string['newwifipassword'] = 'New Wi-Fi password';
$string['newwifissid'] = 'New Wi-Fi network name (SSID)';
...
$string['wifichannelerror'] = 'The Wi-Fi channel must be an integer number between 1 and 11.';
