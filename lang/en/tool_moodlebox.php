...
$string['privacy:null_reason'] = 'The MoodleBox plugin displays information from the Raspberry Pi and enables some configuration changes, but does not effect or store any personal data itself.';
